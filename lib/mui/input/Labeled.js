    ...
    (0, _createClass3.default)(Labeled, [{
        ...
        value: function render() {
            var _props = this.props,
                ...
                rest = (0, _objectWithoutProperties3.default)(_props, ['input', 'isRequired', 'label', 'resource', 'children', 'source', 'disabled', 'labelStyle']);

            if (!label && !source) {
                var componentName = children && children.type && children.type.name;
                throw new Error('Cannot create label for component <' + componentName + '>: You must set either the label or source props. You can also disable automated label insertion by setting \'addLabel: false\' in the component default props');
            }
